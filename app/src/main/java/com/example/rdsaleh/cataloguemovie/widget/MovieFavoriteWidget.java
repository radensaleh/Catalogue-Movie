...
public class MovieFavoriteWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.moviefavorite.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.moviefavorite.EXTRA_ITEM";
